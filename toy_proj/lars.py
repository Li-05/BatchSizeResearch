...
"""
    ...
    我们建议使用create_optimizer_lars并设置bn_bias_separately=True,
    而不是直接使用Lars类。这有助于LARS跳过BatchNormalization和偏置中的参数,
    通常具有更好的性能。多项式Warmup学习率衰减也有助于提高性能。
"""
...
class Lars(Optimizer):
    ...
    实现了LARS优化器,来自论文"Large batch training of convolutional networks"。
